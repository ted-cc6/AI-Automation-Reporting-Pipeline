...
_base_n = rows outside the valid scope (the at-risk population for violations). ERROR threshold: violation > 1% of base_n._
...
|---|---|---|---|
| flag_negative_coping — True count | > 0 and ≤ 363 | 73 | PASS ✓ |
| flag_negative_coping — non-NaN outside insured-event rows | = 0 violations | 0 | PASS ✓ |
| flag_promoter — True count | = 924 | 924 | PASS ✓ |
| flag_paid_claimant — True count | = 58 | 58 | PASS ✓ |
| flag_child_wellbeing_denominator — True count | = 1,928 | 1928 | PASS ✓ |
| insurance_type[health] | = 1,672 | 1672 | PASS ✓ |
| insurance_type[crop] | = 154 | 154 | PASS ✓ |
| insurance_type[credit_life] | = 285 | 285 | PASS ✓ |
...
| `q_claim_submitted` | insured event | 363 | 100.0% | conditional on insured event — low fill vs 2,111 |
